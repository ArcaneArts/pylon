...
class Pylon<T> extends StatelessWidget {
  ...
  /// Example:
  /// ```dart
  /// Pylon.pushReplacement(context, widget) // replace route
  /// ```
  ...
  /// The [type] is the type of route to create (material or cupertino).
  /// The [route] is an optional custom route to use instead of the default.
  /// The [predicate] is a function that determines whether a route should remain on the stack.
  ///
  /// Returns a [Future] that completes with the value returned by the new route.
  ///
  /// Example:
  /// ```dart
  /// Pylon.pushAndRemoveUntil(context, widget, (route) => route is DialogRoute()) // push route, pop all dialogs
  /// ```
  ...
  ///
  /// The [context] is the build context from which to get current pylons.
  /// The [builder] is a function that builds the route's primary contents.
  /// The [settings] are optional route settings.
  ///
  ...
  /// Example:
  /// ```dart
  /// MaterialPageRoute route = Pylon.materialPageRoute(context, (context) => widget);
  /// ```
  ...
  /// Example:
  /// ```dart
  /// CupertinoPageRoute route = Pylon.cupertinoPageRoute(context, (context) => widget);
  /// ```
  ...
  ///
  /// The [context] is the starting build context.
  /// The [ignoreLocals] determines whether to ignore pylons with [local] set to true.
  ///
  ...
  ///
  /// The [context] is the build context from which to get current pylons.
  /// The [builder] is the builder function to wrap with pylons.
  ///
  ...
  ///
  /// The [child] is the new child widget.
  ///
  /// Returns a new [Pylon] widget.
  ///
  /// Example:
  /// ```dart
  /// Pylon<String> newPylon = oldPylon.copyWithChild(newChild);
  /// ```
  ...
  ///
  /// The [builder] is the new builder function.
  ///
  /// Returns a new [Pylon] widget.
  ///
  /// Example:
  /// ```dart
  /// Pylon<String> newPylon = oldPylon.copyWithBuilder(newBuilder);
  /// ```
