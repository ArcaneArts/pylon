...
/// A widget that combines a [StreamBuilder] with a [Pylon] to provide reactive state management for streams.
///
...
/// context extensions (e.g., [context.pylon]<T>()) without directly managing stream subscriptions
/// or explicitly rebuilding.
///
...
class PylonStream<T> extends StatelessWidget {
  ...
  /// value is passed to a [Pylon] widget to update its value reactively.
  ...
  /// Builds the widget by using a [StreamBuilder] to listen to the [stream] and conditionally
  /// render either the [loading] widget or a [Pylon] with the current stream data passed to the [builder].
  @override
